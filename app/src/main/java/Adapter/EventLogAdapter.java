...
public class EventLogAdapter extends ArrayAdapter {

    public EventLogAdapter(Context context, int textViewRessourceId){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView == null){
            result = LayoutInflater.from(getContext()).inflate(R.layout.ligne_prof, parent, false);
        }
